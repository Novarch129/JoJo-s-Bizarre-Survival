...
public class ItemSummonMadeInHeaven extends Item
{
	private boolean hasStand;
	private int standID;

	public ItemSummonMadeInHeaven(Properties properties)
	{
		super(properties);
		this.hasStand = true;
	...
	{
		return Rarity.create("mih", TextFormatting.GREEN);
	}
	...
	public enum MadeInHeaven implements IExtensibleEnum
	{
		MIH(TextFormatting.GREEN);

		public final TextFormatting color;

		private MadeInHeaven(TextFormatting format)
		{
			this.color = format;
		}

		public static MadeInHeaven create(String name, TextFormatting format)
		{
