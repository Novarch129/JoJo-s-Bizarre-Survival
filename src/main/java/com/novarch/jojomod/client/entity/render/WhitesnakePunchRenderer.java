...
public class WhitesnakePunchRenderer extends EntityRenderer<AbstractStandPunchEntity.Whitesnake>
{
	protected WhitesnakePunchModel<AbstractStandPunchEntity.Whitesnake> punch;
	...
	public WhitesnakePunchRenderer(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new WhitesnakePunchModel<>();
	}
	...
	{
		return WhitesnakePunchRenderer.texture;
	}
}
