...
public class PurpleHazePunchRenderer extends EntityRenderer<AbstractStandPunchEntity.PurpleHaze>
{
	protected PurpleHazePunchModel<AbstractStandPunchEntity.PurpleHaze> punch;
	...
	public PurpleHazePunchRenderer(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new PurpleHazePunchModel<>();
	}
	...
	public void renderEntityModel(@Nonnull AbstractStandPunchEntity.PurpleHaze entityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
	...
	{
		return PurpleHazePunchRenderer.texture;
	}
}
