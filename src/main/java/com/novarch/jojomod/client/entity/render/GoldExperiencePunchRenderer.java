...
public class GoldExperiencePunchRenderer extends EntityRenderer<AbstractStandPunchEntity.GoldExperience>
{
	protected GoldExperiencePunchModel<AbstractStandPunchEntity.GoldExperience> punch;
	...
	public GoldExperiencePunchRenderer(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new GoldExperiencePunchModel<>();
	}

	@Override
	public void render(@Nonnull AbstractStandPunchEntity.GoldExperience entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
		renderEntityModel(entityIn, matrixStackIn, bufferIn, packedLightIn);
	}

	public void renderEntityModel(@Nonnull AbstractStandPunchEntity.GoldExperience entityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
	...
	@Nonnull
	@Override
	public ResourceLocation getEntityTexture(final AbstractStandPunchEntity.GoldExperience entity)
	{
		return GoldExperiencePunchRenderer.texture;
	}
}
