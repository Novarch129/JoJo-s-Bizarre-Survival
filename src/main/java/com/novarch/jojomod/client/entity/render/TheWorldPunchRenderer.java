...
public class TheWorldPunchRenderer extends EntityRenderer<AbstractStandPunchEntity.TheWorld>
{
	protected TheWorldPunchModel<AbstractStandPunchEntity.TheWorld> punch;
	...
	public TheWorldPunchRenderer(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new TheWorldPunchModel<>();
	}
	...
	public void renderEntityModel(@Nonnull AbstractStandPunchEntity.TheWorld entityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
	...
	@Nonnull
	@Override
	public ResourceLocation getEntityTexture(final AbstractStandPunchEntity.TheWorld entity)
	{
		return TheWorldPunchRenderer.texture;
	}
}
