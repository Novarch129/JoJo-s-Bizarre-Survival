...
public class WeatherReportPunchRenderer extends EntityRenderer<AbstractStandPunchEntity.WeatherReport>
{
	protected WeatherReportPunchModel<AbstractStandPunchEntity.WeatherReport> punch;
	...
	public WeatherReportPunchRenderer(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new WeatherReportPunchModel<>();
	}

	@Override
	public void render(@Nonnull AbstractStandPunchEntity.WeatherReport entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
		renderEntityModel(entityIn, matrixStackIn, bufferIn, packedLightIn);
	}

	public void renderEntityModel(@Nonnull AbstractStandPunchEntity.WeatherReport entityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
	...
	@Nonnull
	@Override
	public ResourceLocation getEntityTexture(final AbstractStandPunchEntity.WeatherReport entity)
	{
		return WeatherReportPunchRenderer.texture;
	}
}
