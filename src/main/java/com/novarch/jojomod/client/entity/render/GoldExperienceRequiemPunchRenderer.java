...
public class GoldExperienceRequiemPunchRenderer extends EntityRenderer<AbstractStandPunchEntity.GoldExperienceRequiem>
{
	protected GoldExperienceRequiemPunchModel<AbstractStandPunchEntity.GoldExperienceRequiem> punch;
	...
	public GoldExperienceRequiemPunchRenderer(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new GoldExperienceRequiemPunchModel<>();
	}
	...
	{
		return GoldExperienceRequiemPunchRenderer.texture;
	}
}
