...
public class MadeInHeavenPunchRenderer extends EntityRenderer<AbstractStandPunchEntity.MadeInHeaven>
{
	protected MadeInHeavenPunchModel<AbstractStandPunchEntity.MadeInHeaven> punch;
	...
	public MadeInHeavenPunchRenderer(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new MadeInHeavenPunchModel<>();
	}
	...
	public void renderEntityModel(@Nonnull AbstractStandPunchEntity.MadeInHeaven entityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
	...
	{
		return MadeInHeavenPunchRenderer.texture;
	}
}
