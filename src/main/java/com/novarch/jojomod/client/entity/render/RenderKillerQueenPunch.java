...
import com.novarch.jojomod.client.entity.model.ModelKillerQueenPunch;
...
public class RenderKillerQueenPunch extends EntityRenderer<AbstractStandPunchEntity.KillerQueen>
{
	protected ModelKillerQueenPunch<AbstractStandPunchEntity.KillerQueen> punch;
	...
	public RenderKillerQueenPunch(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new ModelKillerQueenPunch<>();
	}
	...
	public void renderEntityModel(@Nonnull AbstractStandPunchEntity.KillerQueen entityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
