...
public class SilverChariotSwordRenderer extends EntityRenderer<AbstractStandPunchEntity.SilverChariot>
{
	protected SilverChariotSwordModel<AbstractStandPunchEntity.SilverChariot> sword;
	...
	public SilverChariotSwordRenderer(EntityRendererManager renderManagerIn)
	{
		...
		sword = new SilverChariotSwordModel<>();
	}
	...
	public void renderEntityModel(@Nonnull AbstractStandPunchEntity.SilverChariot entityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
	...
	{
		return SilverChariotSwordRenderer.texture;
	}
}
