...
public class KingCrimsonPunchRenderer extends EntityRenderer<AbstractStandPunchEntity.KingCrimson>
{
	protected KingCrimsonPunchModel<AbstractStandPunchEntity.KingCrimson> punch;
	...
	public KingCrimsonPunchRenderer(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new KingCrimsonPunchModel<>();
	}
	...
	{
		return KingCrimsonPunchRenderer.texture;
	}
}
