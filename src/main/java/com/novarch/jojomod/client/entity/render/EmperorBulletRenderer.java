...
public class EmperorBulletRenderer extends EntityRenderer<EmperorBulletEntity>
{
	...
	public EmperorBulletRenderer(EntityRendererManager renderManagerIn)
	{
		...
		this.bullet = new EmperorBulletModel<>();
	}
	...
	public void renderEntityModel(@Nonnull EmperorBulletEntity entityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
	...
	{
		return EmperorBulletRenderer.texture;
	}
}
