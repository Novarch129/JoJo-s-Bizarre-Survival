...
import com.novarch.jojomod.client.entity.model.ModelCMoonPunch;
...
public class RenderCMoonPunch extends EntityRenderer<AbstractStandPunchEntity.CMoon>
{
	protected ModelCMoonPunch<AbstractStandPunchEntity.CMoon> punch;
	...
	public RenderCMoonPunch(EntityRendererManager renderManagerIn)
	{
		...
		this.punch = new ModelCMoonPunch<>();
	}
