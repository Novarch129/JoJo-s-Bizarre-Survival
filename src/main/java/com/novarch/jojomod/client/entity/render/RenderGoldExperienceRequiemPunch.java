...
import com.novarch.jojomod.client.entity.model.ModelGoldExperienceRequiemPunch;
...
public class RenderGoldExperienceRequiemPunch extends EntityRenderer<AbstractStandPunchEntity.GoldExperienceRequiem>
{
	protected ModelGoldExperienceRequiemPunch<AbstractStandPunchEntity.GoldExperienceRequiem> punch;
	...
	public RenderGoldExperienceRequiemPunch(EntityRendererManager renderManagerIn) 
	{
		...
		this.punch = new ModelGoldExperienceRequiemPunch<>();
	}
	...
	public void renderEntityModel(@Nonnull AbstractStandPunchEntity.GoldExperienceRequiem entityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
