...
{
	protected ModelWeatherReportPunch punch;
	...
	public void renderEntityModel(@Nonnull EntityStandPunch.weatherReport entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
