...
public class TheHandPunchEntity extends AbstractStandPunchEntity {
    public TheHandPunchEntity(EntityType<? extends AbstractStandPunchEntity> type, World worldIn) {
        super(type, worldIn);
    }
