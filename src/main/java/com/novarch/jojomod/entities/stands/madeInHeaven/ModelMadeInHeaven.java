package com.novarch.jojomod.entities.stands.madeInHeaven;// Made with Blockbench 3.5.1
...
public class ModelMadeInHeaven <T extends EntityMadeInHeaven> extends EntityModel<T> {
