package com.novarch.jojomod.entities.stands.theEmperor;
...
public class EntityEmperorBullet extends Entity implements IProjectile {
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.createKey(EntityEmperorBullet.class, DataSerializers.BYTE);
    protected static final DataParameter<Optional<UUID>> field_212362_a = EntityDataManager.createKey(EntityEmperorBullet.class, DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Byte> PIERCE_LEVEL = EntityDataManager.createKey(EntityEmperorBullet.class, DataSerializers.BYTE);
    @Nullable
    private BlockState inBlockState;
    protected boolean inGround;
    protected int timeInGround;
    public EntityEmperorBullet.PickupStatus pickupStatus = EntityEmperorBullet.PickupStatus.DISALLOWED;
    ...
    public EntityEmperorBullet(double x, double y, double z, World worldIn) {
    ...
    public EntityEmperorBullet(EntityType<? extends Entity> entityType, World world) {
    ...
    public void readAdditional(CompoundNBT compound) {
        ...
        if (compound.contains("pickup", 99)) {
            this.pickupStatus = EntityEmperorBullet.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        } else if (compound.contains("player", 99)) {
            this.pickupStatus = compound.getBoolean("player") ? EntityEmperorBullet.PickupStatus.ALLOWED : EntityEmperorBullet.PickupStatus.DISALLOWED;
        }
    ...
    public void setShooter(@Nullable Entity entityIn) {
        ...
        if (entityIn instanceof PlayerEntity) {
            this.pickupStatus = ((PlayerEntity)entityIn).abilities.isCreativeMode ? EntityEmperorBullet.PickupStatus.CREATIVE_ONLY : EntityEmperorBullet.PickupStatus.ALLOWED;
        }
    ...
    public void onCollideWithPlayer(PlayerEntity entityIn) {
        if (!this.world.isRemote && (this.inGround || this.getNoClip()) && this.arrowShake <= 0) {
            boolean flag = this.pickupStatus == EntityEmperorBullet.PickupStatus.ALLOWED || this.pickupStatus == EntityEmperorBullet.PickupStatus.CREATIVE_ONLY && entityIn.abilities.isCreativeMode || this.getNoClip() && this.getShooter().getUniqueID() == entityIn.getUniqueID();
