...
public class RenderDirtyDeedsDoneDirtCheapPunch extends EntityRenderer<EntityStandPunch.dirtyDeedsDoneDirtCheap>
{
	...
	public void renderEntityModel(@Nonnull EntityStandPunch.dirtyDeedsDoneDirtCheap entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
