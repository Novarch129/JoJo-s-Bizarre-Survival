...
public class MadeInHeavenEntity extends AbstractStandEntity {
	...
	public MadeInHeavenEntity(EntityType<? extends AbstractStandEntity> type, World world) {
		...
		this.standID = Util.StandID.MADE_IN_HEAVEN;
	}
		...
		if (getMaster() != null) {
			...
			if (player.isSprinting()) {
				...
				if (!this.world.isRemote) {
					...
					if (this.oratick == 1) {
						...
						AbstractStandPunchEntity.MadeInHeaven madeInHeaven = new AbstractStandPunchEntity.MadeInHeaven(this.world, this, player);
			...
			if (this.orarush) {
				...
				if (this.oratickr >= 10)
					if (!this.world.isRemote) {
						player.setSprinting(false);
						AbstractStandPunchEntity.MadeInHeaven madeInHeaven1 = new AbstractStandPunchEntity.MadeInHeaven(this.world, this, player);
						...
						AbstractStandPunchEntity.MadeInHeaven madeInHeaven2 = new AbstractStandPunchEntity.MadeInHeaven(this.world, this, player);
