...
public class GoldExperienceRequiemPunchEntity extends AbstractStandPunchEntity {
    public GoldExperienceRequiemPunchEntity(EntityType<? extends AbstractStandPunchEntity> type, World worldIn) {
        super(type, worldIn);
    }
