...
public class DirtyDeedsDoneDirtCheapEntity extends AbstractStandEntity {
	private int oratick = 0;

	private int oratickr = 0;

	public DirtyDeedsDoneDirtCheapEntity(EntityType<? extends AbstractStandEntity> type, World world) {
		super(type, world);
		this.spawnSound = SoundInit.SPAWN_D4C.get();
		this.standID = Util.StandID.D4C;
	}

	public DirtyDeedsDoneDirtCheapEntity(World world) {
