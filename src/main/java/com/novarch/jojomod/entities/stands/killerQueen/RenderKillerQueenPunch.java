...
{
	protected ModelKillerQueenPunch punch;
	...
	public void renderEntityModel(@Nonnull EntityStandPunch.killerQueen entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
