...
public class KingCrimsonPunchEntity extends AbstractStandPunchEntity {
    public KingCrimsonPunchEntity(EntityType<? extends AbstractStandPunchEntity> type, World worldIn) {
        super(type, worldIn);
    }
