				...
				if (player.isSprinting()) {
					...
					if (!this.world.isRemote) {
						...
						if (this.oratick == 1) {
							...
							dirtyDeedsDoneDirtCheap.shoot(player, player.rotationPitch, player.rotationYaw, 0.0F, 2.0F, 0.2F);
				...
				if (this.orarush) {
					...
					if (this.oratickr >= 10)
						if (!this.world.isRemote) {
							...
							dirtyDeedsDoneDirtCheap1.shoot(player, player.rotationPitch, player.rotationYaw, 0.0F, 2.0F, 0.2F);
							...
							dirtyDeedsDoneDirtCheap2.shoot(player, player.rotationPitch, player.rotationYaw, 0.0F, 2.0F, 0.2F);
