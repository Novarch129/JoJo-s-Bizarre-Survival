...
public class RenderGoldExperienceRequiemPunch extends EntityRenderer<EntityStandPunch.goldExperienceRequiem>
{
	...
	public void renderEntityModel(@Nonnull EntityStandPunch.goldExperienceRequiem entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
