...
public class ItemInit
{
	...
	//public static final RegistryObject<MusicDiscItem> canzoni_preferite = ITEMS.register("canzoni_preferite", () -> new ItemCanzoniPreferite(10, SoundInit.CANZONI_PREFERITE.get(), new Item.Properties().group(JojoItemGroup.instance)));
}
