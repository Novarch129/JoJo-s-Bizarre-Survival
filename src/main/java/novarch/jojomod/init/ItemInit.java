...
import novarch.jojomod.JojoBizarreSurvival.JojoItemGroup;
import novarch.jojomod.item.EmperorItem;
import novarch.jojomod.item.RemoveStandItem;
import novarch.jojomod.item.StandArrowItem;
import novarch.jojomod.item.StandDiscItem;
...
public class ItemInit {
    ...
    public static final RegistryObject<Item> REMOVE_STAND = ITEMS.register("remove_stand", () -> new RemoveStandItem(new Item.Properties().maxStackSize(1).rarity(Rarity.create("stand_disc", TextFormatting.GRAY)).group(JojoItemGroup.INSTANCE)));
