...
import novarch.jojomod.entities.stands.attacks.GoldExperiencePunchEntity;
import net.minecraft.client.renderer.entity.model.EntityModel;
import net.minecraft.client.renderer.model.ModelRenderer;

public class GoldExperiencePunchModel extends EntityModel<GoldExperiencePunchEntity> {
    ...
    @Override
    public void setRotationAngles(GoldExperiencePunchEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
