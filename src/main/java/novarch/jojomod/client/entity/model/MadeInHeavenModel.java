package novarch.jojomod.client.entity.model;// Made with Blockbench 3.5.1
...
import novarch.jojomod.entities.stands.MadeInHeavenEntity;
import net.minecraft.client.renderer.entity.model.EntityModel;
import net.minecraft.client.renderer.model.ModelRenderer;

public class MadeInHeavenModel<T extends MadeInHeavenEntity> extends EntityModel<T> {
