...
import novarch.jojomod.init.KeyInit;
...
import static novarch.jojomod.network.message.client.CSyncAerosmithPacket.Action.MOVE;
import static novarch.jojomod.network.message.client.CSyncAerosmithPacket.Direction.*;
