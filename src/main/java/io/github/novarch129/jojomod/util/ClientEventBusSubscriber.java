...
import io.github.novarch129.jojomod.client.entity.model.*;
import io.github.novarch129.jojomod.client.entity.render.*;
import io.github.novarch129.jojomod.event.EventClientTick;
import io.github.novarch129.jojomod.event.EventHandleKeybinds;
...
public class ClientEventBusSubscriber {
    ...
    public static void clientSetup(FMLClientSetupEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityInit.KING_CRIMSON_PUNCH.get(), manager -> new StandAttackRenderer<>(manager, new DefaultStandAttackModel<>()));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityInit.ECHOES_SOUND.get(), manager -> new StandAttackRenderer<>(manager, new EchoesSoundModel()));
