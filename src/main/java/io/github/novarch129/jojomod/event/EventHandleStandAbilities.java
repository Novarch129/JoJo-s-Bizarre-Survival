    ...
    public static void xpEvent(PlayerXpEvent.XpChange event) {
        ...
        Stand.getLazyOptional(player).ifPresent(stand -> {
            if (Util.StandID.EVOLUTION_STANDS.contains(stand.getStandID())) {
                ...
                } else if (stand.getExperiencePoints() >= 25000 && stand.getPrevExperiencePoints() < 25000 && stand.getExperiencePoints() < JojoBizarreSurvivalConfig.COMMON.gerXpPoints.get()) {
                ...
                } else if (stand.getExperiencePoints() >= JojoBizarreSurvivalConfig.COMMON.gerXpPoints.get() && stand.getPrevExperiencePoints() < JojoBizarreSurvivalConfig.COMMON.gerXpPoints.get()) {
