package io.github.novarch129.jojomod.client.entity.model;// Made with Blockbench 3.5.2
...
public class AerosmithModel<T extends AerosmithEntity> extends EntityModel<T> {
