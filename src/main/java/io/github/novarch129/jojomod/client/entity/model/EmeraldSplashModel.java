...
public class EmeraldSplashModel extends EntityModel<EmeraldSplashEntity> {
    ...
    @Override
    public void setRotationAngles(EmeraldSplashEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
