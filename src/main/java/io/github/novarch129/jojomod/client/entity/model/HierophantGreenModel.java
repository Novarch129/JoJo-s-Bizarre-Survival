...
public class HierophantGreenModel extends EntityModel<HierophantGreenEntity> {
    ...
    @Override
    public void setRotationAngles(HierophantGreenEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
