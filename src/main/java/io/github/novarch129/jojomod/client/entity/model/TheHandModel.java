...
public class TheHandModel extends EntityModel<TheHandEntity> {
    ...
    @Override
    public void setRotationAngles(TheHandEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
