...
import io.github.novarch129.jojomod.entities.stands.attacks.TheWorldPunchEntity;
import net.minecraft.client.renderer.entity.model.EntityModel;
import net.minecraft.client.renderer.model.ModelRenderer;

public class TheWorldPunchModel extends EntityModel<TheWorldPunchEntity> {
    ...
    @Override
    public void setRotationAngles(TheWorldPunchEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
